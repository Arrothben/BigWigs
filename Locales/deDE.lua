...
L.compartmentMenu = "Kein Compartment Icon" --"No compartment icon"
L.compartmentMenu_desc = "Ausschalten dieser Option listet BigWigs im Addon Compartment an der Minimap. Wir empfehlen, die Option eingeschaltet zu lassen." -- "Turning this option off will make BigWigs show up in the addon compartment menu. We recommend leaving this option enabled."
